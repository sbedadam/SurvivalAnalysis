...
class KMUtils():
    ...
    def PlotKMEstimatesForCategoricalVariables(self, data = None, categorical_columns=[]):
    ...
    def PlotKMEstimatesForContinuousVariables(self, data = None, continuous_columns=[]):
